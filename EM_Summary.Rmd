...
```{r eval=TRUE, echo=FALSE, message=FALSE, cache=TRUE, fig.cap=paste('Figure 1. Movement kernels using fixed diffusion rates of', D1[1], '(+/-',D1[2],') and ', D2[1], '(+/-', D2[2],') for [A] migratory and [B] resident movement states, respectively.'), fig.width=7}
