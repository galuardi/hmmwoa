...
plot.loess.pdt <- function(days,depth,temperature,year,tempRange = c(0,32),writePDF=TRUE,
  ...
  #
  # Inputs:
  #   DAYS is a row vector of days to plot along x axis (must match length of columns in matrix TEMPERATURE)
  #   DEPTH is a row vector of depths to plot along y axis (must match length of ROWS in matrix TEMPERATURE)
  #   TEMPERATURE is a DEPTH X DAYS matrix of temperature values interpolated using grid2dloess.r
  #   YEAR is row vector of years corresponding to days on x axis (meant only for checking for leap year and labelling accordingly)
  #   TEMPRANGE is temperature range of input matrix TEMPERATURE
  #   WRITEPDF is argument to determine whether the plot should be output to file as .pdf or just displayed
  #     this one is not yet functional so keep default of writing out
  #   FILENAME is character string to name your output .pdf
  #   DOY.FIRST is integer vector of length one indicating first day of year in the data to ensure correct date labeling
  #   ZISSOU is logical to determine whether plot is created with zissou color ramp and fonts
  #     - currently this is done with a zissou color ramp from https://github.com/karthik/wesanderson#wes-anderson-palettes
  #     - would like to add Futura font functionality to this logical
  #
  # Output:
  #   PDF file of plot as described above
  #
  #
  # Revisions Needed:
  ...
  #
  #=====================================================================================
  # - written by Camrin Braun, April 2014
  #=====================================================================================
  require(oce);
  # setup some plotting variables
  leap.year=seq(1904,2104,by=4)
  monthLabels = c('1Jan','1Feb','1Mar','1Apr','1May','1Jun','1Jul','1Aug','1Sep','1Oct','1Nov','1Dec')
